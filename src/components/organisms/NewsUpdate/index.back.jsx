    ...
    <div className="news">
      <div className="news-update">
        ...
        <div className="image-wrapper">
          <img className="img-fluid image" src="/images/news/1.jpg"  alt="" />
        </div>
        ...
        <div className="row">
          <div className="col-lg-4 d-flex">
            <div className="kb-card">
              <div className="image-wrapper">
                <img src="/images/news/3.jpg" className="image img-fluid" alt="" />
              </div>
              <div className="body">
          ...
          <div className="col-lg-4 d-flex">
            <div className="kb-card">
              <div className="image-wrapper">
                <img src="/images/news/2.jpg" className="image img-fluid" alt="" />
              </div>
              <div className="body">
                <span className="title">
                  Wokee+ KB Bukopin
          ...
          <div className="col-lg-4 d-flex">
            <div className="kb-card">
              <div className="image-wrapper">
                <img src="/images/news/1.jpg" className="image img-fluid" alt="" />
              </div>
              <div className="body">
                <span className="title">
                  Wokee+ KB Bukopin
